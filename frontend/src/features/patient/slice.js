...
export const getPatient = () => {
    return (dispatch, getState) => {
		...
		jsonResult["D_PatientCharacteristics"]['D_7_1_r_StructuredInformationMedicalHistory'] = medHistoryData;
		...
		Object.values(drugHistory).forEach((item, index) => {
			...
			itemData['D_8_r_7b_ReactionMedDRACode'] = item['D_8_r_7b_ReactionMedDRACode']
		...
		jsonResult['D_PatientCharacteristics']['D_9_2_r_CauseDeath'] = causeOfDeathData;
		jsonResult['D_PatientCharacteristics']['D_9_4_r_AutopsyDeterminedCauseDeath'] = autopsyData;
		...
		jsonResult['D_PatientCharacteristics']['D_10_7_MedicalHistoryParent'] = {
		...
		jsonResult["D_PatientCharacteristics"]['D_10_8_r_PastDrugHistoryParent'] = parentDrugHistoryData;
