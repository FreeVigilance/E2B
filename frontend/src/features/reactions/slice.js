...
export const getReaction = () => {
    return (dispatch, getState) => {
		...
		Object.values(reactionsData).forEach((item, index) => {
			...
			itemData['E_i_3_2a_ResultsDeath'] =  (item['E_i_3_2a_ResultsDeath']['value'] === false
						? {'value': null, 'nullFlavor': 'NI'}
						: item['E_i_3_2a_ResultsDeath']);
			itemData['E_i_3_2b_LifeThreatening'] =  (item['E_i_3_2b_LifeThreatening']['value'] === false
						? {'value': null, 'nullFlavor': 'NI'}
						: item['E_i_3_2b_LifeThreatening']);
			itemData['E_i_3_2c_CausedProlongedHospitalisation'] =  (item['E_i_3_2c_CausedProlongedHospitalisation']['value'] === false
						? {'value': null, 'nullFlavor': 'NI'}
						: item['E_i_3_2c_CausedProlongedHospitalisation']);
			itemData['E_i_3_2d_DisablingIncapacitating'] =  (item['E_i_3_2d_DisablingIncapacitating']['value'] === false
						? {'value': null, 'nullFlavor': 'NI'}
						: item['E_i_3_2d_DisablingIncapacitating']);	
			itemData['E_i_3_2e_CongenitalAnomalyBirthDefect'] =  (item['E_i_3_2e_CongenitalAnomalyBirthDefect']['value'] === false
						? {'value': null, 'nullFlavor': 'NI'}
						: item['E_i_3_2e_CongenitalAnomalyBirthDefect']);
			itemData['E_i_3_2f_OtherMedicallyImportantCondition'] =  (item['E_i_3_2f_OtherMedicallyImportantCondition']['value'] === false
						? {'value': null, 'nullFlavor': 'NI'}
