...
export const getDrug = () => {
    return (dispatch, getState) => {
		...
		Object.values(drugs).forEach((item, index) => {
			...
			itemData['G_k_2_1_2a_PhPIDVersion'] = item['G_k_2_1_2a_PhPIDVersion'];
			itemData['G_k_2_1_2b_PhPID'] = item['G_k_2_1_2b_PhPID'];
			itemData['G_k_2_2_MedicinalProductNamePrimarySource'] = item['G_k_2_2_MedicinalProductNamePrimarySource'];
			itemData['G_k_2_4_IdentificationCountryDrugObtained'] = item['G_k_2_4_IdentificationCountryDrugObtained'];
			itemData['G_k_2_5_InvestigationalProductBlinded'] = item['G_k_2_5_InvestigationalProductBlinded'];
			...
			itemData['G_k_3_1_AuthorisationApplicationNumber'] = item['G_k_3_1_AuthorisationApplicationNumber'];
			itemData['G_k_3_2_CountryAuthorisationApplication'] = item['G_k_3_2_CountryAuthorisationApplication'];
			itemData['G_k_3_3_NameHolderApplicant'] = item['G_k_3_3_NameHolderApplicant'];
			...
			itemData['G_k_5a_CumulativeDoseFirstReactionNum'] = item['G_k_5a_CumulativeDoseFirstReactionNum'];
			itemData['G_k_5b_CumulativeDoseFirstReactionUnit'] = item['G_k_5b_CumulativeDoseFirstReactionUnit'];
			itemData['G_k_6a_GestationPeriodExposureNum'] = item['G_k_6a_GestationPeriodExposureNum'];
			itemData['G_k_6b_GestationPeriodExposureUnit'] = item['G_k_6b_GestationPeriodExposureUnit'];
			...
			Object.values(drugReactionMatrix[index]).forEach((subItem, subIndex) => {
				let data = {
					...
					'G_k_9_i_3_2b_IntervalLastDoseDrugReactionUnit': subItem['G_k_9_i_3_2b_IntervalLastDoseDrugReactionUnit'],
					'G_k_9_i_4_ReactionRecurReadministration': subItem['G_k_9_i_4_ReactionRecurReadministration'],
				};
				let relatednessData = []
				...
				data['G_k_9_i_2_r_AssessmentRelatednessDrugReaction'] = relatednessData;
...
export const parseDrug = (data) => {
	...
	if (data) {
		Object.values(data).forEach((item, index) => {
			...
			drugsData['G_k_2_1_2a_PhPIDVersion'] = item['G_k_2_1_2a_PhPIDVersion'];
			drugsData['G_k_2_1_2b_PhPID'] = item['G_k_2_1_2b_PhPID'];
			drugsData['G_k_2_2_MedicinalProductNamePrimarySource'] = item['G_k_2_2_MedicinalProductNamePrimarySource'];
			drugsData['G_k_2_4_IdentificationCountryDrugObtained'] = item['G_k_2_4_IdentificationCountryDrugObtained'];
			drugsData['G_k_2_5_InvestigationalProductBlinded'] = item['G_k_2_5_InvestigationalProductBlinded'];

			drugsData['G_k_3_1_AuthorisationApplicationNumber'] = item['G_k_3_1_AuthorisationApplicationNumber'];
			drugsData['G_k_3_2_CountryAuthorisationApplication'] = item['G_k_3_2_CountryAuthorisationApplication'];
			drugsData['G_k_3_3_NameHolderApplicant'] = item['G_k_3_3_NameHolderApplicant'];
			drugsData['G_k_5a_CumulativeDoseFirstReactionNum'] = item['G_k_5a_CumulativeDoseFirstReactionNum'];
			drugsData['G_k_5b_CumulativeDoseFirstReactionUnit'] = item['G_k_5b_CumulativeDoseFirstReactionUnit'];
			drugsData['G_k_6a_GestationPeriodExposureNum'] = item['G_k_6a_GestationPeriodExposureNum'];
			drugsData['G_k_6b_GestationPeriodExposureUnit'] = item['G_k_6b_GestationPeriodExposureUnit'];
