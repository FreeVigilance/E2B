...
export const getData = createAsyncThunk('display/getData', (id) => {
    return api.getData(id);
});

export const saveData = createAsyncThunk('display/saveData', (data) => {
    return api.saveData(data);
});

export const changeData = createAsyncThunk('display/changeData', (data) => {
    return api.changeData(data);
});

export const deleteReport = createAsyncThunk('display/deleteReport', (id) => {
...
export const validateData = createAsyncThunk('display/validateData', (data) => {
...
export const getTabsWithErrors = (errors) => {
    ...
    if ( 
        ...
        !errors['D_PatientCharacteristics']['D_10_8_r_PastDrugHistoryParent'] &&
        !errors['D_PatientCharacteristics'][
...
const displaySlice = createSlice({
    ...
    reducers: {
        ...
        setShowCasesList: (state, action) => {
            state.showCasesList = action.payload;
        },
        setOpenNewReport: (state, action) => {
            state.openNewReport = action.payload;
        },
        ...
        setCurrentSaved: (state, action) => {
            state.currentSaved = action.payload;
        },
        ...
        setCurrentValidated: (state, action) => {
            state.currentValidated = action.payload;
        },
    },
