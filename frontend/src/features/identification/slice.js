...
export const getIdentification = () => {
    return (dispatch, getState) => {
        ...
        jsonResult['C_1_IdentificationCaseSafetyReport']['C_1_6_1_r_DocumentsHeldSender'] = getState().identification.documentsHeldBySender;
        jsonResult['C_1_IdentificationCaseSafetyReport']['C_1_9_1_r_SourceCaseId'] = getState().identification.otherIdentifiers;
        jsonResult['C_1_IdentificationCaseSafetyReport']['C_1_10_r_IdentificationNumberReportLinked'] = getState().identification.identificationNumber;
