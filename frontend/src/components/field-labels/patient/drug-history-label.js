...
export const DrugHistoryFieldLabel = ({label, field, index}) => {
    ...
    const createLabel = () => {
        if (errors['D_PatientCharacteristics'] && errors['D_PatientCharacteristics']['D_8_r_PastDrugHistory']) {
            const errorText = getErrorText(errors['D_PatientCharacteristics']['D_8_r_PastDrugHistory'][index]);
            if (errorText === null) {
