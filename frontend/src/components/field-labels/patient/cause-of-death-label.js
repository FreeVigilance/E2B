...
export const CauseOfDeathFieldLabel = ({label, field, index}) => {
    ...
    const createLabel = () => {
        if (errors['D_PatientCharacteristics'] && errors['D_PatientCharacteristics']['D_9_2_r_CauseDeath']) {
            const errorText = getErrorText(errors['D_PatientCharacteristics']['D_9_2_r_CauseDeath'][index]);
            if (errorText === null) {
