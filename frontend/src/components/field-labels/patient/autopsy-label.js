...
export const AutopsyFieldLabel = ({label, field, index}) => {
    ...
    const createLabel = () => {
        if (errors['D_PatientCharacteristics'] && errors['D_PatientCharacteristics']['D_9_4_r_AutopsyDeterminedCauseDeath']) {
            const errorText = getErrorText(errors['D_PatientCharacteristics']['D_9_4_r_AutopsyDeterminedCauseDeath'][index]);
            if (errorText === null) {
