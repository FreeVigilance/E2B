...
export const ParentHistoryFieldLabel = ({label, field}) => {
    ...
    const createLabel = () => {
        if (errors['D_PatientCharacteristics'] && errors['D_PatientCharacteristics']['D_10_7_2_TextMedicalHistoryParent']) {
            const errorText = getErrorText(errors['D_PatientCharacteristics']['D_10_7_2_TextMedicalHistoryParent']);
            if (errorText === null) {
