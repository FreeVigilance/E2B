...
export const ParentDrugHistoryFieldLabel = ({label, field, index}) => {
    ...
    const createLabel = () => {
        if (errors['D_PatientCharacteristics'] && errors['D_PatientCharacteristics']['D_10_8_r_PastDrugHistoryParent']) {
            const errorText = getErrorText(errors['D_PatientCharacteristics']['D_10_8_r_PastDrugHistoryParent'][index]);
            if (errorText === null) {
