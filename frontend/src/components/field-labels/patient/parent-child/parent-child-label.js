...
export const ParentChildFieldLabel = ({label, field}) => {
    ...
    const createLabel = () => {
        if (errors['D_PatientCharacteristics'] && errors['D_PatientCharacteristics']['D_10_InformationConcerningParent']) {
            const errorText = getErrorText(errors['D_PatientCharacteristics']['D_10_InformationConcerningParent']);
            if (errorText === null) {
