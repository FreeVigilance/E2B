...
export const ParentInfoFieldLabel = ({label, field, index}) => {
    ...
    const createLabel = () => {
        if (errors['D_PatientCharacteristics'] && errors['D_PatientCharacteristics']['D_10_7_1_r_StructuredInformationParentMedDRACode']) {
            const errorText = getErrorText(errors['D_PatientCharacteristics']['D_10_7_1_r_StructuredInformationParentMedDRACode'][index]);
            if (errorText === null) {
