...
export const MedHistoryFieldLabel = ({label, field, index}) => {
    ...
    const createLabel = () => {
        if (errors['D_PatientCharacteristics'] && errors['D_PatientCharacteristics']['D_7_MedicalHistory']) {
            const errorText = getErrorText(errors['D_PatientCharacteristics']['D_7_MedicalHistory'][index]);
            if (errorText === null) {
