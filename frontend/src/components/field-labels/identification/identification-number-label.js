...
export const IdentificationNumberFieldLabel = ({label, field, index}) => {
    ...
    const createLabel = () => {
        ...
        errors['C_1_IdentificationCaseSafetyReport']['C_1_10_r_IdentificationNumberReportLinked']) {
            const errorText = getErrorText(errors['C_1_IdentificationCaseSafetyReport']['C_1_10_r_IdentificationNumberReportLinked'][index]);
            if (errorText === null) {
