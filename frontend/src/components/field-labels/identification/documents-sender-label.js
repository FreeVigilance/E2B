...
export const DocumentsSenderFieldLabel = ({label, field, index}) => {
    ...
    const createLabel = () => {
        ...
        errors['C_1_IdentificationCaseSafetyReport']['C_1_6_1_r_DocumentsHeldSender']) {
            const errorText = getErrorText(errors['C_1_IdentificationCaseSafetyReport']['C_1_6_1_r_DocumentsHeldSender'][index]);
            if (errorText === null) {
