...
export const OtherIdentifiersFieldLabel = ({label, field, index}) => {
    ...
    const createLabel = () => {
        ...
        errors['C_1_IdentificationCaseSafetyReport']['C_1_9_1_r_SourceCaseId']) {
            const errorText = getErrorText(errors['C_1_IdentificationCaseSafetyReport']['C_1_9_1_r_SourceCaseId'][index]);
            if (errorText === null) {
