...
export const SubstanceFieldLabel = ({label, field, drugIndex, index}) => {
    ...
    const createLabel = () => {
        ...
        errors['G_k_DrugInformation'][drugIndex]['G_k_2_3_r_SubstanceIdStrength']) {
            const errorText = getErrorText(errors['G_k_DrugInformation'][drugIndex]['G_k_2_3_r_SubstanceIdStrength'][index]);
            if (errorText === null) {
