...
export const MatrixFieldLabel = ({label, field, drugIndex, index}) => {
    ...
    const createLabel = () => {
        ...
        errors['G_k_DrugInformation'][drugIndex]['G_k_9_i_DrugReactionMatrix']) {
            const errorText = getErrorText(errors['G_k_DrugInformation'][drugIndex]['G_k_9_i_DrugReactionMatrix'][index]);
            if (errorText === null) {
