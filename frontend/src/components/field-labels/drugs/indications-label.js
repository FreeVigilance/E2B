...
export const IndicationsFieldLabel = ({label, field, drugIndex, index}) => {
    ...
    const createLabel = () => {
        ...
        errors['G_k_DrugInformation'][drugIndex]['G_k_7_r_IndicationUseCase']) {
            const errorText = getErrorText(errors['G_k_DrugInformation'][drugIndex]['G_k_7_r_IndicationUseCase'][index]);
            if (errorText === null) {
