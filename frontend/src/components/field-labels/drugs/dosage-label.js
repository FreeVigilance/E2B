...
export const DosageFieldLabel = ({label, field, drugIndex, index}) => {
    ...
    const createLabel = () => {
        ...
        errors['G_k_DrugInformation'][drugIndex]['G_k_4_r_DosageInformation']) {
            const errorText = getErrorText(errors['G_k_DrugInformation'][drugIndex]['G_k_4_r_DosageInformation'][index]);
            if (errorText === null) {
