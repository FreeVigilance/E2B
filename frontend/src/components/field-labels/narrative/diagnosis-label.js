...
export const DiagnosisFieldLabel = ({label, field, index}) => {
    ...
    const createLabel = () => {
        ...
        errors['H_NarrativeCaseSummary']['H_3_r_SenderDiagnosisMedDRACode']) {
            const errorText = getErrorText(errors['H_NarrativeCaseSummary']['H_3_r_SenderDiagnosisMedDRACode'][index]);
            if (errorText === null) {
