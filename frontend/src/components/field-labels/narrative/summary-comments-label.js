...
export const SummaryCommentsFieldLabel = ({label, field, index}) => {
    ...
    const createLabel = () => {
        ...
        errors['H_NarrativeCaseSummary']['H_5_r_CaseSummaryReporterCommentsNativeLanguage']) {
            const errorText = getErrorText(errors['H_NarrativeCaseSummary']['H_5_r_CaseSummaryReporterCommentsNativeLanguage'][index]);
            if (errorText === null) {
