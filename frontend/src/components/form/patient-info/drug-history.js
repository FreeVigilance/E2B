                    ...
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={9}>
                            <TextField variant="outlined"
                                ...
                                onChange={handleChange('D_8_r_6a_MedDRAVersionIndication', index, true, 4)}
                                type='number'
                                onKeyDown={(evt) =>
                        ...
                        <Grid item xs={9}>
                            <TextField variant="outlined"
                                className={classes.textXshort}
                                onChange={handleChange('D_8_r_6b_IndicationMedDRACode', index, true, 8)}
                                type='number'
                                onKeyDown={(evt) =>
                        ...
                        <Grid item xs={9}>
                            <TextField variant="outlined"
                                className={classes.textXshort}
                                onChange={handleChange('D_8_r_7a_MedDRAVersionReaction', index, true, 4)}
                                type='number'
                                onKeyDown={(evt) =>
                                    (evt.key === "-" || evt.key === "+" || evt.key === "e" || evt.key === ",") &&
                                    evt.preventDefault()
                        ...
                        <Grid item xs={9}>
                            <TextField variant="outlined"
                                className={classes.textXshort}
                                onChange={handleChange('D_8_r_7b_ReactionMedDRACode', index, true, 8)}
                                type='number'
                                onKeyDown={(evt) =>
                                    (evt.key === "-" || evt.key === "+" || evt.key === "e" || evt.key === "," || evt.key === ".") &&
                                    evt.preventDefault()
