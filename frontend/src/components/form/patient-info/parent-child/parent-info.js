                ...
                >
                    <CardContent>
                        <Grid container spacing={2}>
                            <Grid item xs={3}>
                                <ParentInfoFieldLabel
                                    label="MedDRA Version for Medical History"
                                    field="D_10_7_1_r_1a_MedDRAVersionMedicalHistory"
                                    index={index}
                                ></ParentInfoFieldLabel>
                            </Grid>
                            <Grid item xs={9}>
                            ...
                            <Grid item xs={3}>
                                <ParentInfoFieldLabel
                                    ...
                                    field="D_10_7_1_r_1b_MedicalHistoryMedDRACode"
                                    index={index}
                                ></ParentInfoFieldLabel>
                            </Grid>
                            <Grid item xs={9}>
                            ...
                            <Grid item xs={9}>
                                ...
                                >
                                    ...
                                    {parentData[index]['D_10_7_1_r_4_EndDate'][
                                        'nullFlavor'
                                    ] === null ? (
                                        <InputMask
                                            mask="9999-99-99 99:99:99"
