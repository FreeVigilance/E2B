                        ...
                        <Grid container spacing={2}>
                            <Grid item xs={3}>
                                <AutopsyFieldLabel
                                    ...
                                    field="D_9_4_r_2_AutopsyDeterminedCauseDeath"
                                    index={index}
                                ></AutopsyFieldLabel>
                            </Grid>
                            <Grid item xs={9}>
                            ...
                            <Grid item xs={3}>
                                <AutopsyFieldLabel
                                    label="MedDRA Version for Autopsy-determined Cause of Death"
                                    field="D_9_4_r_1a_MedDRAVersionAutopsyDeterminedCauseDeath"
                                    index={index}
                                ></AutopsyFieldLabel>
                            </Grid>
                            <Grid item xs={9}>
                            ...
                            <Grid item xs={3}>
                                <AutopsyFieldLabel
                                    label="Autopsy-determined Cause of Death (MedDRA code)"
                                    field="D_9_4_r_1b_AutopsyDeterminedCauseDeathMedDRACode"
                                    index={index}
                                ></AutopsyFieldLabel>
                            </Grid>
                            <Grid item xs={9}>
