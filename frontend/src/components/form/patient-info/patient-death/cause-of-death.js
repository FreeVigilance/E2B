                ...
                >
                    <CardContent>
                        <Grid container spacing={2}>
                            <Grid item xs={3}>
                                <CauseOfDeathFieldLabel
                                    label="Reported Cause of Death"
                                    field="D_9_2_r_2_CauseDeath"
                                    index={index}
                                ></CauseOfDeathFieldLabel>
                            </Grid>
                            <Grid item xs={9}>
                            ...
                            <Grid item xs={3}>
                                <CauseOfDeathFieldLabel
                                    label="MedDRA Version for Reported Cause(s) of Death"
                                    field="D_9_2_r_1a_MedDRAVersionCauseDeath"
                                    index={index}
                                ></CauseOfDeathFieldLabel>
                            </Grid>
                            <Grid item xs={9}>
                            ...
                            <Grid item xs={3}>
                                <CauseOfDeathFieldLabel
                                    label="Reported Cause of Death (MedDRA code)"
                                    field="D_9_2_r_1b_CauseDeathMedDRACode"
                                    index={index}
                                ></CauseOfDeathFieldLabel>
                            </Grid>
                            <Grid item xs={9}>
