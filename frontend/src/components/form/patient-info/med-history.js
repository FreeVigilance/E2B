                ...
                >
                    <CardContent>
                        <Grid container spacing={2}>
                            <Grid item xs={3}>
                                <MedHistoryFieldLabel
                                    label="MedDRA Version for Medical History"
                                    field="D_7_1_r_1a_MedDRAVersionMedicalHistory"
                                    index={index}
                                ></MedHistoryFieldLabel>
                            </Grid>
                            <Grid item xs={9}>
                            ...
                            <Grid item xs={3}>
                                <MedHistoryFieldLabel
                                    label="Medical History MedDRA code"
                                    field="D_7_1_r_1b_MedicalHistoryMedDRACode"
                                    index={index}
                                ></MedHistoryFieldLabel>
                            </Grid>
                            <Grid item xs={9}>
                            ...
                            <Grid item xs={3}>
                                <MedHistoryFieldLabel
                                    label="Family History Present"
                                    field="D_7_1_r_6_FamilyHistory"
                                    index={index}
                                ></MedHistoryFieldLabel>
                            </Grid>
                            <Grid item xs={9}>
                            ...
                            <Grid item xs={9}>
                                ...
                                >
                                    ...
                                    {medicalHistory[index]['D_7_1_r_4_EndDate'][
                                        'nullFlavor'
                                    ] === null ? (
                                        <InputMask
                                            mask="9999-99-99 99:99:99"
