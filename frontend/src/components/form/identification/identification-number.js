...
export const IdentificationNumberComp = () => {
    ...
    const handleChange = (fieldName, index) => (event) => {
        ...
        let identificationNumberCopy = JSON.parse(
            JSON.stringify(identificationNumber),
        );
                ...
                >
                    <CardContent>
                        <Stack direction={'column'} gap={2}>
                            <IdentificationNumberFieldLabel
                                label="Identification Number of the Report Which Is Linked to This Report"
                                field="C_1_10_r_IdentificationNumberReportLinked"
                                index={index}
                            ></IdentificationNumberFieldLabel>
                            <TextField
                                variant="outlined"
