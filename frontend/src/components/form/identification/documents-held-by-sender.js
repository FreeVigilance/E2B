...
export const DocumentsHeldBySenderComp = () => {
    ...
    const handleChange = (fieldName, index) => (event) => {
        ...
        let documentsHeldBySenderCopy = JSON.parse(
            JSON.stringify(documentsHeldBySender),
        );
                ...
                >
                    <CardContent>
                        <Grid container spacing={2}>
                            <Grid item xs={3}>
                                <DocumentsSenderFieldLabel
                                    label="Documents Held by Sender"
                                    field="C_1_6_1_r_1_DocumentsHeldSender"
                                    index={index}
                                ></DocumentsSenderFieldLabel>
                            </Grid>
                            <Grid item xs={9}>
                                <TextField
                                    ...
                                    onChange={handleChange(
                                        'C_1_6_1_r_1_DocumentsHeldSender',
                                        index,
                                    )}
                                    value={
                                        item['C_1_6_1_r_1_DocumentsHeldSender']
                                            .value
                                    }
                                    multiline
