                ...
                >
                    <CardContent>
                        <Grid container spacing={2}>
                            <Grid item xs={3}>
                                <OtherIdentifiersFieldLabel
                                    label="Source(s) of the Case Identifier"
                                    field="C_1_9_1_r_1_SourceCaseId"
                                    index={index}
                                ></OtherIdentifiersFieldLabel>
                            </Grid>
                            <Grid item xs={9}>
                                <TextField
                                    ...
                                    onChange={handleChange(
                                        'C_1_9_1_r_1_SourceCaseId',
                                        index,
                                    )}
                                    value={
                                        item['C_1_9_1_r_1_SourceCaseId'].value
                                    }
                                    multiline
                            ...
                            <Grid item xs={3}>
                                <OtherIdentifiersFieldLabel
                                    label="Case Identifier(s)"
                                    field="C_1_9_1_r_2_CaseId"
                                    index={index}
                                ></OtherIdentifiersFieldLabel>
                            </Grid>
                            <Grid item xs={9}>
