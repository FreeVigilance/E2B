...
export const NarrativeComp = () => {
    ...
    const handleChange = (fieldName) => (event) => {
        ...
        let narrativeCaseSummaryCopy = JSON.parse(
            JSON.stringify(narrativeCaseSummary),
        );
    ...
    return (
        <>
            <Stack direction="column" spacing={2} justifyContent="flex-start">
                <NarrativeFieldLabel
                    label="Case Narrative Including Clinical Course, Therapeutic Measures, Outcome and 
            Additional Relevant Information"
                    field="H_1_CaseNarrative"
                ></NarrativeFieldLabel>
                <TextField
                    variant="outlined"
            ...
            <Grid container direction="row" columnGap={4}>
                ...
                <Grid container item xs direction="column" rowGap={1}>
                    ...
                    >
                        Case Summary and Reporter’s Comments
                    </FormLabel>
