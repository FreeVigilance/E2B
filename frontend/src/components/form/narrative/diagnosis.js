                ...
                >
                    <CardContent>
                        <Grid container spacing={2}>
                            <Grid item xs={5}>
                                <DiagnosisFieldLabel
                                    label="MedDRA Version for Sender's Diagnosis"
                                    field="H_3_r_1a_MedDRAVersionSenderDiagnosis"
                                    index={index}
                                ></DiagnosisFieldLabel>
                            </Grid>
                            <Grid item xs={7}>
                                <TextField
                                    ...
                                    onChange={handleChange(
                                        'H_3_r_1a_MedDRAVersionSenderDiagnosis',
                                        index,
                                        true,
                                        4,
                                    )}
                            ...
                            <Grid item xs={5}>
                                <DiagnosisFieldLabel
                                    label="Sender's Diagnosis (MedDRA code)"
                                    field="H_3_r_1b_SenderDiagnosisMedDRAcode"
                                    index={index}
                                ></DiagnosisFieldLabel>
                            </Grid>
                            <Grid item xs={7}>
                                <TextField
                                    ...
                                    onChange={handleChange(
                                        'H_3_r_1b_SenderDiagnosisMedDRAcode',
                                        index,
                                        true,
                                        8,
                                    )}
