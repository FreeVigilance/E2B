...
export const Reactions = () => {
                    ...
                    <CardContent>
                        <Stack direction={'column'} spacing={3}>
                            ...
                            <Grid container spacing={2}>
                                <Grid item xs={3}>
                                    <ReactionFieldLabel
                                        label="Reported by the Primary Source in Native Language"
                                        field="E_i_1_1a_ReactionPrimarySourceNativeLanguage"
                                        index={index}
                                    ></ReactionFieldLabel>
                                </Grid>
                                <Grid item xs={9}>
                                ...
                                <Grid item xs={3}>
                                    <ReactionFieldLabel
                                        label="Reported by the Primary Source Language"
                                        field="E_i_1_1b_ReactionPrimarySourceLanguage"
                                        index={index}
                                    ></ReactionFieldLabel>
                                </Grid>
                                <Grid item xs={9}>
                                ...
                                <Grid item xs={3}>
                                    <ReactionFieldLabel
                                        label="Reported by the Primary Source for Translation"
                                        field="E_i_1_2_ReactionPrimarySourceTranslation"
                                        index={index}
                                    ></ReactionFieldLabel>
                                </Grid>
                                <Grid item xs={9}>
                                ...
                                <Grid container spacing={2}>
                                    <Grid item xs={4}>
                                        <ReactionFieldLabel
                                            ...
                                            field="E_i_2_1a_MedDRAVersionReaction"
                                            index={index}
                                        ></ReactionFieldLabel>
                                    </Grid>
                                    <Grid item xs={8}>
                                    ...
                                    <Grid item xs={4}>
                                        <ReactionFieldLabel
                                            ...
                                            field="E_i_2_1b_ReactionMedDRACode"
                                            index={index}
                                        ></ReactionFieldLabel>
                                    </Grid>
                                    <Grid item xs={8}>
                                    ...
                                    <Grid item xs={4}>
                                        <ReactionFieldLabel
                                            ...
                                            field="E_i_3_1_TermHighlightedReporter"
                                            index={index}
                                        ></ReactionFieldLabel>
                                    </Grid>
                                    <Grid item xs={8}>
                                        ...
                                        >
                                            <MenuItem value={1}>
                                                1 = Yes, highlighted by the
                                                reporter, NOT serious
                                            </MenuItem>
                                            <MenuItem value={2}>
                                                2 = No, not highlighted by the
                                                reporter, NOT serious
                                            </MenuItem>
                                            <MenuItem value={3}>
                                                3 = Yes, highlighted by the
                                                reporter, SERIOUS
                                            </MenuItem>
                                            <MenuItem value={4}>
                                                4 = No, not highlighted by the
                                                reporter, SERIOUS
                                            </MenuItem>
                                        </Select>
                                    </Grid>
                                    ...
                                    <Grid item xs={4}>
                                        <ReactionFieldLabel
                                            ...
                                            field="E_i_7_OutcomeReactionLastObservation"
                                            index={index}
                                        ></ReactionFieldLabel>
                                    </Grid>
                                    <Grid item xs={8}>
                                    ...
                                    <Grid item xs={4}>
                                        <ReactionFieldLabel
                                            ...
                                            field="E_i_8_MedicalConfirmationHealthcareProfessional"
                                            index={index}
                                        ></ReactionFieldLabel>
                                    </Grid>
                                    <Grid item xs={8}>
                                    ...
                                    <Grid item xs={4}>
                                        <ReactionFieldLabel
                                            ...
                                            field="E_i_9_IdentificationCountryReaction"
                                            index={index}
                                        ></ReactionFieldLabel>
                                    </Grid>
                                    <Grid item xs={8}>
                                ...
                                <Grid container spacing={2}>
                                    ...
                                    <Grid item xs={4}>
                                        <ReactionFieldLabel
                                            ...
                                            field="E_i_3_2b_LifeThreatening"
                                            index={index}
                                        ></ReactionFieldLabel>
                                    </Grid>
                                    <Grid item xs={8}>
                                    ...
                                    <Grid item xs={4}>
                                        <ReactionFieldLabel
                                            ...
                                            field="E_i_3_2c_CausedProlongedHospitalisation"
                                            index={index}
                                        ></ReactionFieldLabel>
                                    </Grid>
                                    <Grid item xs={8}>
                                    ...
                                    <Grid item xs={4}>
                                        <ReactionFieldLabel
                                            ...
                                            field="E_i_3_2d_DisablingIncapacitating"
                                            index={index}
                                        ></ReactionFieldLabel>
                                    </Grid>
                                    <Grid item xs={8}>
                                    ...
                                    <Grid item xs={4}>
                                        <ReactionFieldLabel
                                            ...
                                            field="E_i_3_2e_CongenitalAnomalyBirthDefect"
                                            index={index}
                                        ></ReactionFieldLabel>
                                    </Grid>
                                    <Grid item xs={8}>
                                    ...
                                    <Grid item xs={4}>
                                        <ReactionFieldLabel
                                            ...
                                            field="E_i_3_2f_OtherMedicallyImportantCondition"
                                            index={index}
                                        ></ReactionFieldLabel>
                                    </Grid>
                                    <Grid item xs={8}>
                                    ...
                                    <Grid item xs={4}>
                                        <ReactionFieldLabel
                                            ...
                                            field="E_i_6a_DurationReactionNum"
                                            index={index}
                                        ></ReactionFieldLabel>
                                    </Grid>
                                    <Grid item xs={8}>
                                    ...
                                    <Grid item xs={4}>
                                        <ReactionFieldLabel
                                            ...
                                            field="E_i_6b_DurationReactionUnit"
                                            index={index}
                                        ></ReactionFieldLabel>
                                    </Grid>
                                    <Grid item xs={8}>
    ...
    const removeForm = (index) => {
        ...
        if (drugInd !== null && matrixInd !== null) {
            ...
            for (
                let ind = matrixInd;
                ind <= Object.keys(relatedness[drugInd]).length;
                ind++
            ) {
                relatednessCopy[drugInd][ind] =
                    relatednessCopy[drugInd][ind + 1];
            }
