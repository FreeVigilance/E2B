...
export const DrugTabs = () => {
    ...
    const createNewDrug = () => {
        ...
        const drugReactionMatrixCopy = JSON.parse(
    ...
    const deleteDrug = (index) => {
        let answer = window.confirm(
            `Are you sure you want to remove drug ${index}?`,
        );
        if (!answer) return;
