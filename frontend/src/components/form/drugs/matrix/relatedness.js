...
export const Relatednesses = ({ drugIndex, matrixIndex }) => {
    ...
    const formList = () => {
        ...
        Object.values(relatedness[drugIndex][matrixIndex]).forEach(
            (item, index) => {
                list.push(
                    <Card
                        sx={{
                    ...
                    >
                        <CardContent>
                            ...
                            >
                                <RelatednessFieldLabel
                                    label="Source of Assessment"
                                    field="G_k_9_i_2_r_1_SourceAssessment"
                                    drugIndex={drugIndex}
                                ...
                                <TextField
                                    ...
                                    value={
                                        item['G_k_9_i_2_r_1_SourceAssessment']
                                            .value
                                    }
                                />
                                ...
                                <RelatednessFieldLabel
                                    ...
                                    field="G_k_9_i_2_r_2_MethodAssessment"
                                    drugIndex={drugIndex}
                                    matrixIndex={matrixIndex}
                                    index={index}
                                ></RelatednessFieldLabel>
                                ...
                                <TextField
                                    ...
                                    value={
                                        item['G_k_9_i_2_r_2_MethodAssessment']
                                            .value
                                    }
                                />
                                ...
                                <RelatednessFieldLabel
                                    ...
                                    field="G_k_9_i_2_r_3_ResultAssessment"
                                    drugIndex={drugIndex}
                                    matrixIndex={matrixIndex}
                                    index={index}
                                ></RelatednessFieldLabel>
                                <TextField
                                    ...
                                    value={
                                        item['G_k_9_i_2_r_3_ResultAssessment']
                                            .value
                                    }
                                />
                            </Stack>
                            ...
                            {index ===
                            relatedness[drugIndex][matrixIndex].length - 1 ? (
                                <span>
                                    <IconButton
                                        size="large"
