                ...
                >
                    <CardContent>
                        <Grid container spacing={2}>
                            <Grid item xs={3}>
                                <AddInfoFieldLabel
                                    label="Additional Information on Drug (coded)"
                                    field="G_k_10_r_AdditionalInformationDrug"
                                    drugIndex={drugIndex}
                                    index={index}
                                ></AddInfoFieldLabel>
                            </Grid>
                            <Grid item xs={9}>
                                ...
                                >
                                    ...
                                    <MenuItem value={5}>
                                        5 = Batch and lot tested and found
                                        within specifications
                                    </MenuItem>
                                    <MenuItem value={6}>
                                        6 = Batch and lot tested and found not
                                        within specifications
                                    </MenuItem>
                                    <MenuItem value={7}>
                                        7 = Medication error
